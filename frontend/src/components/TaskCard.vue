<template>
  <div class="task-card">
    ...
    <div class="task-actions">
      <button v-if="!task.completed" class="btn-edit" @click.stop="$emit('edit')" title="Editează sarcina">
      ...
      <button class="btn-delete" @click.stop="$emit('delete')" title="Șterge sarcina">
        <svg class="icon" viewBox="0 0 24 24" width="16" height="16">
